      ...
      newHtml += `
        <div class="thumbnail"> 
          ...
          <div class="imageContainer">
            <a href="${data.records[i].fields.CohortURL}" target="_blank"><img class="thumbnail_img" src="${data.records[i].fields.CohortImage[0].url}" alt="${data.records[0].fields.Name}"></a>
          </div>
          <div class="name">
